...
public:
	...
	table set_selection(string view_name, string table_name, vector<string> attributes,vector<int> op);						//: select the tuples in a relation that satisfy a particular condition.
